export interface ResearchPdf { url: string; title: string }
export interface ResearchImage { src: string; alt?: string }
...
export const researchItems: ResearchItem[] = (raw as Omit<ResearchItem, "slug">[]).map((r) => ({
  ...r,
