  ...
  const projects = [
    {
      ...
      shortDescription: "An iPhone app that turns any photo into a retro instant-film print and tucks it into Apple Wallet, signed right on the device so anyone can add one with zero setup. Built solo, end to end, and taken through App Store submission.",
